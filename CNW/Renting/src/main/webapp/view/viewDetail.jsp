        ...
        <div class="row">
                    ...
                    <div id="myCarousel-2" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="item active">
                                <img src="<%=rent.getImg()%>" class="img-responsive" alt="" />
                            </div>
                            <!-- Slide 2 -->
                            <div class="item">
                                <img src="<%=rent.getImg()%>" class="img-responsive" alt="" />
            ...
            <div class="col-md-6 col-md-offset-1 col-sm-12 col-xs-12">
                ...
                <h3 class="price-container">
                    <%=rent.getPrices()%>đ/Tháng
                    <small>Bao gồm thuế</small>
                </h3>
                <div class="certified">
                    <ul>
                        <li>
                            <a href="javascript:void(0);">Khu vực<span><%=rent.getArea()%></span></a>
                        </li>
                        <li>
                            <a href="javascript:void(0);">Địa chỉ<span><%=rent.getAddress()%></span></a>
                        </li>
                        <li>
                            <a href="javascript:void(0);">Diện tích<span><%=rent.getAcreage()%></span></a>
                        </li>
                    </ul>
                </div>
                <hr />
                <div class="description description-tabs">
                    <ul id="myTab" class="nav nav-pills">
                        <li class="active"><a href="#more-information" data-toggle="tab" class="no-margin">Thông tin mô tả </a></li>
                        <li class=""><a href="#specifications" data-toggle="tab">Liên hệ chủ ngôi nhà</a></li>
                        <li class=""><a href="#reviews" data-toggle="tab">Nhận xét</a></li>
                    </ul>
                    <div id="myTabContent" class="tab-content">
                        ...
                        <div class="tab-pane fade" id="specifications">
                            <br />
                            <dl class="">
                                <dt>Tên tài khoản chủ sở hửu</dt>
                                <dd><%=rent.getOwnerAccountName()%></dd>

                                <br />

                                <dt>Email</dt>
                                <dd><%=rent.getOwnerEmail()%></dd>
                                <br />

                                <dt>Số điện thoại + zalo</dt>
                                <dd><%=rent.getOwnerPhone()%></dd>
                            </dl>
                        </div>
                ...
                <%
                    ...
                    if ((user != null)&&(user.getId()==rent.getOwnerId())) {
                %>
                <div class="row">
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        <a href="/RentServlet?action=editCard&rentDetailId=<%=rent.getRentDetailId()%>&userId=<%=user.getId()%>" class="btn btn-success btn-lg">Edit</a>
                        <a href="/RentServlet?action=deleteCard&rentDetailId=<%=rent.getRentDetailId()%>" class="btn btn-danger btn-lg">Delete</a>
                    </div>
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        <a href="/RentServlet" class="btn btn-danger btn-lg">Back</a>
                    </div>
                </div>
                <% } else {%>
                <div class="row">
