...
-- Thời gian đã tạo: Th12 13, 2023 lúc 12:20 PM
...
(1, 'Hải Châu', '67 Nguyễn Trãi', 20, 'Vị trí: Đối diện trường Cao Đẳng Miền Nam, cách Emart mới xây 1km. Cách công viên Phần Mềm Quang Trung 1,5km. Tiện di chuyển các trường đại học như VLU, IUH..v..v', 1500000, 1, 1, 'Phòng trọ giá sinh viên quận Hải Châu', 'https://img.thuephongtro.com/images/thumb/2023/12/07/20231207152951-pztcx.jpg'),
(2, 'Thanh Khê', '123 Trần Cao Vân', 30, '- phòng ngủ, bếp, WC riêng\r\n- Được hưởng tiện ích đầy đủ của Khu đô thị Vạn Phúc City dân trí cao,\r\n- Giá cho thuê hỗ trợ 3 tháng đầu giá 3.5 tr/tháng.\r\n- Ký hợp đồng 6-12 tháng đặt cọc 1 tháng.', 3000000, 3, 2, 'Nhà nguyên căn quận Thanh Khê', 'https://img.thuephongtro.com/images/thumb/2023/12/09/20231209102201-5vgi5.jpg'),
(3, 'Sơn Trà', '123 ACX TAN ', 35, '- phòng ngủ, bếp, WC riêng', 3200000, 2, 2, 'Căn hộ mới xây', 'https://img.thuephongtro.com/images/thumb/2021/12/14/20211214111515-5c1jx.jpg'),
...
(1, 'tay', '12345', 'TayKieu', 'tay@gmail.com', '0909090909'),
(2, 'Nhi', '12345', 'ThaoNhi', 'nhi@gmail.com', '098787878787'),
(3, 'tuan', '12345', 'AnhTuan', 'tuan@gmail.com', '02231231');
...
--
ALTER TABLE `rent_detail`
  MODIFY `rent_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
